(()=>{
        ...
        updateSlides: function() {
            ...
            for (let n = 0; n < p; n += 1) {
                ...
                "none" !== a.css("display")) {
                    ...
                    f.push(x),
                    i.centeredSlides ? (T = T + x / 2 + y / 2 + b,
                    0 === y && 0 !== n && (T = T - r / 2 - b),
                    0 === n && (T = T - r / 2 - b),
                    Math.abs(T) < .001 && (T = 0),
    ...
    function A(e) {
        ...
        if (l.noSwiping && (h ? function(e, t=this) {
            return function t(s) {
                return s && s !== n() && s !== a() ? (s.assignedSlot && (s = s.assignedSlot),
    ...
    function G(e) {
        ...
        if (c > i.longSwipesMs) {
            ...
            "next" === t.swipeDirection && (f >= i.longSwipesRatio ? t.slideTo(u + v) : t.slideTo(u)),
            "prev" === t.swipeDirection && (f > 1 - i.longSwipesRatio ? t.slideTo(u + v) : t.slideTo(u))
        } else {
            if (!i.shortSwipes)
                return void t.slideTo(t.activeIndex);
            t.navigation && (o.target === t.navigation.nextEl || o.target === t.navigation.prevEl) ? o.target === t.navigation.nextEl ? t.slideTo(u + v) : t.slideTo(u) : ("next" === t.swipeDirection && t.slideTo(u + v),
    ...
    const V = {
        attachEvents: function() {
            ...
            e.onClick = N.bind(e),
            i.touch && !j && (t.addEventListener("touchstart", F),
            j = !0),
            H(e, "on")
        },
    ...
    Q.use([function({swiper: e, extendParams: t, on: s, emit: i}) {
        function n(t) {
            let s;
            return t && (s = f(t),
    ...
    , function({swiper: e, extendParams: t, on: s, emit: i}) {
        ...
        function d() {
            ...
            if ("fraction" === s.type && (d.find(ee(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
            ...
            "progressbar" === s.type) {
                ...
                d.find(ee(s.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${n}) scaleY(${r})`).transition(e.params.speed)
            }
        ...
        function c() {
            ...
            if ("bullets" === t.type) {
                ...
                n.html(r),
                e.pagination.bullets = n.find(ee(t.bulletClass))
            }
